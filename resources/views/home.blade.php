<x-app-layout>
 ...
 @section('hero')
    <div class="w-full text-center py-32  dark:bg-gray-700">
        <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700 dark:text-gray-900">
            Welcome to <span class="text-purple-700 ">BLOGFORGE</span> <span class="text-gray-900"> News</span>
        </h1>
 ...
 @endsection
        ...
        <div class="mb-10 dark:bg-gray-800  px-7 ">
            ...
            <h2 class="mt-16 mb-5 text-3xl text-purple-600 dark:text-gray-300 font-bold">Latest Posts</h2>
