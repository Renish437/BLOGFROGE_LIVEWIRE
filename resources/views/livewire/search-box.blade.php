   <div id="search-box" wire:keydown.enter="update" >
                    <div>
                        ...
                        <div class="w-52 flex rounded-2xl bg-gray-100  dark:bg-gray-200 py-2 px-3 mb-3 items-center">
                           ...
                           <span class="cursor-pointer" wire:click="update"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
